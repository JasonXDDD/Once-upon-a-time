...
@inject('rootStore')
@observer
export default class StickerImagesArrary extends Component {
    constructor(props) {
        super(props)
    ...
    componentWillReceiveProps() {
        if (this.store.sticker !== this.state.copy) {
          this.parentCopy()
        } 
    }  
